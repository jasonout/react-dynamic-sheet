...
var Encapsulate = function Encapsulate(_ref) {
  ...
  return /*#__PURE__*/React.createElement(root$1.div, _extends({
  ...
  }, rest), /*#__PURE__*/React.createElement(GlobalStyle, null), children);
};
...
var Frame = styled(Encapsulate)(_templateObject$1());
...
var MotionOverlay = motion.custom(Overlay);
var Overlay$1 = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
...
var Body = styled.div(_templateObject2$1());

var MotionContainer = motion.custom(Container);
...
var Modal = function Modal(_ref) {
  ...
  return isOpen && /*#__PURE__*/React.createElement(DialogBase, null, /*#__PURE__*/React.createElement(Overlay$1, {
    ...
    return /*#__PURE__*/React.createElement(MotionContainer, _extends({
      sx: {
        color: "text",
        bg: "background"
      },
      ...
      onClick: onClose
    }), /*#__PURE__*/React.createElement(Body, null, /*#__PURE__*/React.createElement("slot", {
...
var Modal$1 = componentWillAppendToBody(Modal);
...
var CloseButton = styled.div(_templateObject2$2());
var Background = styled.div(_templateObject3());
var Body$1 = styled.div(_templateObject4());
...
var Sheet = function Sheet(_ref3) {
  ...
  var onDragEnd = debounce$1(function (event, info) {
  ...
  return /*#__PURE__*/React.createElement(DialogBase, null, /*#__PURE__*/React.createElement(Overlay$1, _extends({
    sx: {
      overflow: "hidden !important"
    },
    className: "type-".concat(type),
    type: type
  }, overlayOnClick), /*#__PURE__*/React.createElement(FixedBottom, null, /*#__PURE__*/React.createElement(MotionContainer$1, _extends({
    sx: {
      color: "text",
      bg: "white"
    },
    ...
    name: "dynamic-sheet-content"
  }, children), showClose && !isModal ? /*#__PURE__*/React.createElement(CloseButton, {
    className: "close-btn",
    onClick: close
  }, "X") : null)))));
};
...
var BottomSheet = function BottomSheet(_ref4) {
  ...
  }, isOpen && /*#__PURE__*/React.createElement(Sheet, props));
};
...
var BottomSheet$1 = componentWillAppendToBody(BottomSheet);
...
var DynamicSheet = function DynamicSheet(_ref) {
  ...
  if (isMobile) {
    return /*#__PURE__*/React.createElement(BottomSheet$1, {
      isOpen: isOpen,
      onClose: abort,
      type: type,
      showClose: showClose
...
export { BottomSheet$1 as BottomSheet, Modal$1 as Modal };
